        ...
        <div className="row">
          ...
          <div className="col-md-2 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="#" className="text-light">Development cooperation</a></li>
              <li><a href="#" className="text-light">Australia-Bangladesh relationship</a></li>
              <li><a href="#" className="text-light">Job Vacancies</a></li>
            </ul>
          </div>
          ...
          <div className="col-md-2 mb-4">
            ...
            <ul className="list-unstyled">
              <li><a href="#" className="text-light">Visas and migration</a></li>
              <li><a href="#" className="text-light">Travelling to Australia</a></li>
              <li><a href="#" className="text-light">Doing business with Australia</a></li>
              <li><a href="#" className="text-light">Study in Australia</a></li>
            </ul>
          </div>
          ...
          <div className="col-md-4 mb-4">
            ...
            <ul className="list-unstyled">
              <li><a href="#" className="text-light">Department of Foreign Affairs and Trade</a></li>
              <li><a href="#" className="text-light">Department of Home Affairs</a></li>
              <li><a href="#" className="text-light">Visit Australia</a></li>
              <li><a href="#" className="text-light">Austrade</a></li>
